    ...
    <div class="col s6" v-for="cc in contactlist.results">
        <div class="card horizontal">
            <div class="card-stacked">
                ...
                <h5>{{ ucfirst(cc.name.title) }} {{ ucfirst(cc.name.first) }} {{ ucfirst(cc.name.last) }}<br>
                    <small>#{{ cc.id.name }}{{ cc.id.value }}</small></h5>
  ...
  <div class="page-template page-template-home">
    <div class="hero teal lighten-5">
        <div class="hero-content container center-align">
            ...
            <h5>
                <a href="https://www.linkedin.com/in/hamzeen">https://www.linkedin.com/in/hamzeen</a>
            </h5>
        </div>
    </div>
    <div class="container">
